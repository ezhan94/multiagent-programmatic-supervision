...
class MACRO_VRNN(nn.Module):
    ...
    In this version, each agent learns a model for their macro-intents.
    Coordination is induced through the shared hidden state of all macro-intent decoders. 
    Agents can also take macro-intents of all agents as input in their respective decoders.
    """
